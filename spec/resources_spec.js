describe('Resources', function () {
  ...
  describe('Nested Controller', function() {
    ...
    it('call show action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('resources_controller/2/nested_controller/show_123');
        done();
      });
    });
    ...
    it('call destroy action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('resources_controller/2/nested_controller/destroy_123');
        done();
      });
    });
    ...
    it('call update action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('resources_controller/2/nested_controller/update_123');
        done();
      });
    });
    ...
    it('call collection_action action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('resources_controller/2/nested_controller/collection_action');
        done();
      });
    });
    ...
    it('call member_action action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('resources_controller/2/nested_controller/member_action_123');
        done();
      });
    });
  ...
  describe('Double Nested Controller', function() {
    ...
    it('call index action', function(done) {
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('resources_controller/2/nested_controller/3/double_nested_controller/index');
    ...
    it('call create action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('resources_controller/2/nested_controller/3/double_nested_controller/create');
    ...
    it('call show action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('resources_controller/2/nested_controller/3/double_nested_controller/show_123');
        done();
      });
    });
    ...
    it('call destroy action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('resources_controller/2/nested_controller/3/double_nested_controller/destroy_123');
        done();
      });
    });
    ...
    it('call update action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('resources_controller/2/nested_controller/3/double_nested_controller/update_123');
        done();
      });
    });
    ...
    it('call collection_action action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('resources_controller/2/nested_controller/3/double_nested_controller/collection_action');
        done();
      });
    });
    ...
    it('call member_action action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('resources_controller/2/nested_controller/3/double_nested_controller/member_action_123');
        done();
      });
    });
  });
