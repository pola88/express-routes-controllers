...
describe('Resources', function () {
  ...
  describe('Versioned Resources Controller', function() {
    ...
    describe('no header', function() {
      ...
      it('call action for last version', function(done) {
    ...
    describe('unexistent version on header', function() {
      beforeEach(function() {
        this.request.options.url += 'versioned_resources_controller';
    ...
    describe('header with application/vnd.avi-on.v1+json', function() {
      ...
      it('call show action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('v1/versioned_resources_controller/show_123');
          done();
        });
      });
      ...
      it('call destroy action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('v1/versioned_resources_controller/destroy_123');
          done();
        });
      });
      ...
      it('call update action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('v1/versioned_resources_controller/update_123');
          done();
        });
      });
      ...
      it('call collection_action action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('v1/versioned_resources_controller/collection_action');
          done();
        });
      });
      ...
      it('call member_action action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('v1/versioned_resources_controller/member_action_123');
          done();
        });
      });
    ...
    describe('Before', function() {
      ...
      it('call create action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('v1/versioned_before_controllers/create_foo');
      ...
      it('call update action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('v1/versioned_before_controllers/update_foo');
          done();
        });
      });
    ...
    describe('Nested Controller', function() {
      ...
      it('call index action', function(done) {
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('versioned_resources_controller/2/v1/versioned_nested_controller/index');
      ...
      it('call create action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('versioned_resources_controller/2/v1/versioned_nested_controller/create');
      ...
      it('call show action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('versioned_resources_controller/2/v1/versioned_nested_controller/show_123');
          done();
        });
      });
      ...
      it('call destroy action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('versioned_resources_controller/2/v1/versioned_nested_controller/destroy_123');
          done();
        });
      });
      ...
      it('call update action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('versioned_resources_controller/2/v1/versioned_nested_controller/update_123');
          done();
        });
      });
      ...
      it('call collection_action action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('versioned_resources_controller/2/v1/versioned_nested_controller/collection_action');
          done();
        });
      });
      ...
      it('call member_action action', function(done) {
        ...
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('versioned_resources_controller/2/v1/versioned_nested_controller/member_action_123');
          done();
        });
      });
    })
  ...
  describe('header with application/vnd.avi-on.v2+json', function() {
    ...
    it('call destroy action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('v2/versioned_resources_controller/destroy_123');
        done();
      });
    });
    ...
    it('call update action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('v2/versioned_resources_controller/update_123');
        done();
      });
    });
    ...
    it('call collection_action action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('v2/versioned_resources_controller/collection_action');
        done();
      });
    });
    ...
    it('call member_action action', function(done) {
      ...
      this.request.execute(function(error, response, body) {
        expect(body.msg).toEqual('v2/versioned_resources_controller/member_action_123');
        done();
      });
    });
  ...
  describe('Mix of Versioned and Non Versioned Resources Controller', function() {
    describe('parent is not versioned but nested is', function() {
      ...
      it('call action of versioned_nested_controller/index', function(done) {
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('non_versioned_resources_controller/2/v1/versioned_nested_controller/index');
    ...
    describe('parent is versioned but nested is not', function() {
      ...
      it('call action of non_versioned_nested_controller/index', function(done) {
        this.request.execute(function(error, response, body) {
          expect(body.msg).toEqual('versioned_resources_controller/2/non_versioned_nested_controller/index');
