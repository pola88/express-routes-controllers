...
Routes.prototype = {
  _init: function(actions) {
    ...
    _.each(this.actions, function(callback, actionName) {
      ...
      self._addRoute(method, path, before, callback)
          ._store(actionName, method, path);
    });
  },
  ...
  _addRoute: function(method, path, middleware, callback) {
  ...
  _store: function(action, method, path) {
